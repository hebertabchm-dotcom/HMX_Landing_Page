...
import { BarChart2, MousePointerClick, Filter, LayoutDashboard, Database, Megaphone } from 'lucide-react';
...
const services = [
  { 
    ...
    title: 'Tráfego Pago', 
    description: 'Gestão estratégica em Meta Ads, Google Ads e LinkedIn Ads focada em conversão e ROI.' 
  },
  { 
    icon: Filter, 
    title: 'Funis & LPs', 
