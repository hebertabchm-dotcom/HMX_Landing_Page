...
import { Facebook, Instagram, Linkedin, MessageCircle, TrendingUp } from 'lucide-react';
...
export const Footer = () => {
  const whatsappHref = buildWhatsAppUrl('Olá! Vim pela landing page da HMX e quero falar com a equipe.');
