      ...
      <Container>
        <div className="grid md:grid-cols-2 gap-8 md:gap-16">
          <Reveal width="100%" direction="right">
            <div className="bg-bg-secondary/50 p-6 sm:p-8 rounded-[var(--radius-lg)] border border-success/10 hover:border-success/20 transition-colors h-full">
              <h3 className="text-2xl font-bold text-white mb-6 flex items-center gap-2">
                <span className="bg-success/20 text-success p-1 rounded-full">
                  <Check size={20} />
                </span>
                Para quem é a HMX
              </h3>
          ...
          <Reveal width="100%" delay={0.2} direction="left">
            <div className="bg-bg-secondary/20 p-6 sm:p-8 rounded-[var(--radius-lg)] border border-white/5 opacity-80 hover:opacity-100 transition-opacity h-full">
              <h3 className="text-2xl font-bold text-white mb-6 flex items-center gap-2">
                <span className="bg-red-500/20 text-red-500 p-1 rounded-full">
                  <X size={20} />
                </span>
                Para quem NÃO é
              </h3>
