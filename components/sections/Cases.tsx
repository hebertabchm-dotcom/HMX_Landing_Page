...
export const Cases = () => {
  ...
  return (
    <Section id="cases" className="bg-bg-secondary">
      <Container>
        <Reveal width="100%">
          <SectionTitle subtitle="Resultados Reais" title="Quem já escalou com a HMX" />
        </Reveal>

        <div className="grid md:grid-cols-2 lg:gap-8 gap-6 mb-12">
          {cases.map((item, i) => (
            <Reveal key={item.segment} delay={i * 0.1}>
              <Card className="group cursor-default hover:border-accent-primary/50 hover:shadow-[0_0_20px_rgba(14,165,233,0.1)] h-full flex flex-col justify-between">
                <div>
                  ...
                  <div className="space-y-6">
                    <div>
                      <p className="text-[10px] text-text-muted mb-2 uppercase tracking-widest font-bold">
                        Desafio
                      </p>
                    ...
                    <div className="grid grid-cols-2 gap-4 pt-4 border-t border-white/5">
                      ...
                      <div>
                        <p className="text-[10px] text-text-muted mb-2 uppercase tracking-widest font-bold text-accent-primary">
                          Resultado
                        </p>
                        <p className="text-xl font-bold text-white drop-shadow-[0_0_10px_rgba(14,165,233,0.3)]">
                          {item.result}
                        </p>
                      </div>
                    </div>
