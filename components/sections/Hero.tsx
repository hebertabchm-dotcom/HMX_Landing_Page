...
import { ArrowRight, BarChart3, Cpu, Database, TrendingUp } from 'lucide-react';
...
export const Hero = () => {
  ...
  return (
    <Section className="relative pt-28 pb-20 md:pt-48 md:pb-32 overflow-hidden flex flex-col justify-center min-h-[80svh] md:min-h-[90vh]">
      ...
      <Container className="relative z-10 flex flex-col items-center text-center">
        <Reveal width="100%" className="flex justify-center">
          <Badge
            className="mb-8 hover:scale-105 transition-transform cursor-default border-accent-secondary/50"
        ...
        <Reveal delay={0.1} width="100%" className="flex justify-center">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white tracking-tight leading-[1.1] mb-6 max-w-5xl text-center">
            Performance real para vender mais{' '}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-primary to-accent-secondary animate-pulse">
              todos os dias.
            </span>
          </h1>
        </Reveal>
        ...
        <Reveal delay={0.2} width="100%" className="flex justify-center">
          <p className="text-lg md:text-xl text-text-secondary mb-10 max-w-2xl leading-relaxed text-center">
            Estratégia, mídia paga, funil e dados trabalhando juntos para escalar seu faturamento
        ...
        <Reveal delay={0.3} width="100%" className="flex justify-center">
          <div className="flex flex-col sm:flex-row gap-4 w-full justify-center mb-16">
            <Button
              ...
              className="w-full sm:w-auto h-14 px-8 text-lg shadow-accent-primary/20 hover:shadow-accent-primary/40"
            >
              Agendar Diagnóstico{' '}
